  ...
  return (
    <footer className="site-footer">
      <div className="site-footer__logo">
        <img src={LogoBlack} alt="DeFAQto" className="site-footer__logo-image" />
      </div>

      <div className="site-footer__content">
        <p className="site-footer__partners">
          Наши партнёры:{" "}
          <a
            href="https://hiddenbar.ru/"
        ...
        <div className="site-footer__social">
          <p className="site-footer__social-title">Наши соцсети:</p>

          <div className="site-footer__social-icons">
            <a
              className="site-footer__social-link"
              href="http://vkontakte.ru/club20507794"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="DeFAQto во ВКонтакте"
            >
