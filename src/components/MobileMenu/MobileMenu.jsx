...
function MobileMenu(){
    ...
    return(
        <>
            <button className="burger-menu" onClick={() => setIsOpen(!isOpen)} aria-label="Открыть меню">
            ...
            <nav className={`mobile-nav ${isOpen ? 'mobile-nav--open' : 'mobile-nav--closed'}`} aria-label="Мобильное меню">
